    ...
    var Layout = function($) {
        ...
        var Layout = function() {
            ...
            _proto.fixLayoutHeight = function fixLayoutHeight() {
                ...
                $(Selector.CONTENT).css('min-height', (max - heights.footer - 62));
                if ($('body').hasClass(ClassName.LAYOUT_FIXED)) {
                    if (typeof $.fn.overlayScrollbars !== 'undefined') {
...
$('.sidebar').click(function() {
    if ($('body').attr('class') === 'sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed sidebar-open modal-open') {
        $('body').attr('class', 'sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed')
    }
    if ($('body').attr('class') === 'sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed') {
        $('body').attr('class', 'sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed')
    }
})
