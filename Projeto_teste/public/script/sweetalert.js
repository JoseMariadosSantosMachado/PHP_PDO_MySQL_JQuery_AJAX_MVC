!function(t, e) {
    ...
    function ht(t, e) {
        var n, o, i, r, a = I(), c = D(), u = L(), s = q(), l = j();
      ...
      , pe = Object.freeze({
        ...
        mixin: function(r) {
            return function(t) {
                ...
                function() {
                    var t, e = s(n);
                    return p(this, o ? (t = s(this).constructor,
                ...
                return c(i, [{
                    key: "_main",
                    value: function(t) {
                        return f(s(i.prototype), "_main", this).call(this, u({}, r, t))
                    }
                }]),
                i
            }(this)
    ...
    var ve = function() {
      ...
      , ye = function(t) {
        var e = t.target
          , n = k();
        return !we(t) && !Ce(t) && (e === n || !(st(n) || "INPUT" === e.tagName || st(E()) && E().contains(e)))
    }
      , we = function(t) {
    ...
    var Re = ["swal-title", "swal-html", "swal-footer"]
      ...
      , Ue = function(t) {
        ...
        return g(t.querySelectorAll("swal-button")).forEach(function(t) {
            ...
            t.getAttribute("color") && (n["".concat(e, "ButtonColor")] = t.getAttribute("color")),
            t.getAttribute("aria-label") && (n["".concat(e, "ButtonAriaLabel")] = t.getAttribute("aria-label"))
        }),
        n
    }
      , _e = function(t) {
        ...
        t.getAttribute("src") && (e.imageUrl = t.getAttribute("src")),
        t.getAttribute("width") && (e.imageWidth = t.getAttribute("width")),
        t.getAttribute("height") && (e.imageHeight = t.getAttribute("height")),
        t.getAttribute("alt") && (e.imageAlt = t.getAttribute("alt"))),
        e
    }
      , Fe = function(t) {
        var e = {}
        ...
        t.getAttribute("type") && (e.icon = t.getAttribute("type")),
        t.getAttribute("color") && (e.iconColor = t.getAttribute("color")),
      ...
      , ze = function(t) {
        ...
        e.getAttribute("label") && (n.inputLabel = e.getAttribute("label")),
        e.getAttribute("placeholder") && (n.inputPlaceholder = e.getAttribute("placeholder")),
        e.getAttribute("value") && (n.inputValue = e.getAttribute("value")));
      ...
      , cn = function(t, e, n) {
        ...
        e.inputValidator ? un(t, e, o) : t.getInput().checkValidity() ? ("deny" === n ? sn : ln)(t, e, o) : (t.enableButtons(),
    ...
    function xn(t) {
        var e = u({}, ue.showClass, t.showClass)
          , n = u({}, ue.hideClass, t.hideClass)
          , o = function(t) {
            ...
            t = t.content || t;
            return Ke(t),
            u(Ne(t), Ue(t), _e(t), Fe(t), ze(t), We(t, Re))
        }(t);
        return (o = u({}, ue, t, o)).showClass = e,
        o.hideClass = n,
    ...
    function Bn(a, c, u) {
        return new Promise(function(t) {
            ...
            c.denyButton.onclick = function() {
                return e = u,
                (t = a).disableButtons(),
                void (e.returnInputValueOnDeny ? cn(t, e, "deny") : sn(t, e, !1));
                var t, e
            }
            ,
            ...
            r = a,
            "select" === (t = u).input || "radio" === t.input ? en(r, t) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(t.input) && (b(t.inputValue) || w(t.inputValue)) && nn(r, t),
            Ie(u),
            En(ee, u, e),
            Sn(c, u),
            setTimeout(function() {
